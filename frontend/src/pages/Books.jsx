          ...
          <div className="flex-1">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {sortedBooks.map((book) => (
                <Card key={book.id} className="group hover:shadow-lg transition-shadow border-pink-100 py-0 gap-0">
                  <CardContent className="p-4 pb-2">
                    ...
                    <p className="text-sm text-gray-600 mb-2">{book.Author.first_name} {book.Author.last_name}</p>
